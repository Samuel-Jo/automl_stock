...
tickers = {'NVDA': 'NVIDIA Corporation', 'GRAB': 'Grab Holdings Limited', 'WULF': 'TeraWulf Inc', 'LUMN': 'Lumen Technologies, Inc', 
           'OKLO': 'Oklo Inc', 'PLUG': 'Plug Power Inc', 'LCID': 'Lucid Group, Inc', 'SOFI': 'SoFi Technologies, Inc', 
           'TSLA': 'Tesla, Inc', 'MARA': 'MARA Holdings, Inc', 'DJT': 'Trump Media & Technology Group Corp',  'KVUE': 'Kenvue Inc', 
           'SMCI': 'Super, Micro Computer, Inc', 'NIO': 'NIO Inc', 'CLSK': 'CleanSpark, Inc', 'F': 'Ford Motor Company', 
           'INTC': 'Intel Corporation', 'PLTR': 'Palantir Technologies Inc', 'IONQ': 'IonQ, Inc', 'WBD': 'Warner Bros Discovery, Inc', 
           'NOK': 'Nokia Oyj', 'DNN': 'Denison Mines Corp', 'AAPL': 'Apple Inc', 'AAL': 'American Airlines Group Inc', 'AMD': 'Advanced Micro Devices, Inc'}
